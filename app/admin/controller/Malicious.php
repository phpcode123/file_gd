...
class Malicious  extends BaseController
{
    ...
    public function add(){
        ...
        return View::fetch('/Malicious/malicious_add');
    }


    public function addpost(){
        $data = Request::post();
        if(Db::table('tp_malicious_file')->strict(false)->data($data)->insert()){
    ...
    public function list(){
        ...
        $list = Db::table('tp_malicious_file')->order('id','desc')->paginate([
    ...
    public function edit(){
        $id = Request::param('id');
        $data = Db::table('tp_malicious_file')->where('id',$id)->select();
        View::assign('data',$data);
        View::assign('username',Session::get('username'));
        View::assign('admin_path',Config::get('app.admin_path'));
        View::assign('pc_url',Config::get('app.admin_url'));
        return View::fetch('/Malicious/malicious_edit');
    }

    public function editpost(){
        $data = Request::param();
        if(Db::table('tp_malicious_file')->strict(false)->where('id',$data['id'])->update($data)){
    ...
    public function delete(){
        ...
        if(Db::table('tp_malicious_file')->where('id',$id)->delete()){
